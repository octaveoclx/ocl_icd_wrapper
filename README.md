This branch will trick the opencl apps with runtime to show the support of FP16 with cl_khr_fp16 flag. It has been tested with clBlast where the FP16 math operations are available with Apple silicon devices.
